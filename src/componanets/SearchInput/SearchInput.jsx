...
const SearchInput = ({ doctors }) => {
  ...
  const filterSearch = doctors.filter((doctor) => {
    return doctor.name.toLowerCase().includes(search.toLowerCase().trim());
  });

  return (
    <div>
      <div className="mb-8 flex justify-between items-center">
        <h1 className="text-5xl font-semibold text-info">All Doctors</h1>
        <StyledWrapper>
