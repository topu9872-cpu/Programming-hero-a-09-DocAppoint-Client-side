...
const FormInput = ({ label, type = "text", ...props }) => (
  <label className="relative w-full block">
    <input
      ...
      {...props}
    />
    <span className="absolute left-2.5 top-4 text-gray-400 text-[0.9em] cursor-text transition-all duration-300 
...
const RegisterPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
      <form className="flex flex-col gap-3 w-full max-w-88 bg-white p-5 rounded-[20px] shadow-sm font-sans">
        
        {/* Header Section */}
        <div className="space-y-1">
          <p className="text-[28px] tracking-tight relative flex items-center pl-8 text-blue-600 font-semibold
        ...
        <div className="flex gap-2 w-full">
          ...
          <FormInput label="Url" name="imageUrl" />
        </div>
        ...
        {/* Submit Actions */}
        <button type="submit" className="w-full bg-blue-600 p-2.5 rounded-[10px] text-white font-medium transition-all duration-300 hover:bg-blue-700 cursor-pointer mt-1">
          Submit
        </button>

        <p className="text-sm text-gray-500/80 text-center">
          Already have an account?{" "}
          <a href="#" className="text-blue-600 hover:underline font-medium">Signin</a>
        </p>
